  ...
  return (
    ...
    >
      ...
      <Link href="/" style={{ display: "flex", alignItems: "center", gap: "10px", textDecoration: "none" }}>
        ...
        >
          Postman<span style={{ background: "linear-gradient(90deg, #ff9e00 0%, #ff6b00 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>AI</span>
        </span>
      </Link>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
        ...
        <Link href="/dashboard" style={{ textDecoration: "none" }}>
          <button
            style={{
              ...
              boxShadow: "inset 0 1px 0px rgba(255,255,255,0.05), 0 1px 2px rgba(0,0,0,0.4)",
          ...
          >
            ...
            <svg 
              ...
              style={{ width: "14px", height: "14px", stroke: "currentColor", color: "#a1a1aa" }}
            >
        ...
        {loading ? (
          <div style={{ width: "32px", height: "32px", borderRadius: "50%", backgroundColor: "#1f1f2e" }} className="animate-pulse" />
        ) : user ? (
          <UserMenu user={user} />
        ) : (
